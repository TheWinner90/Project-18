...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 17 mai 2026 à 08:56
...
INSERT INTO `candidatures` (`id`, `offre_id`, `etudiant_id`, `cv`, `lettre_motivation`, `message`, `statut`, `date_candidature`) VALUES
(1, 1, 14, NULL, NULL, 'je suis un pationne de developpement web mobile ', 'acceptee', '2026-05-11 08:16:08'),
(2, 1, 20, NULL, NULL, '', 'en_attente', '2026-05-14 17:52:42');
...
CREATE TABLE `certifications` (
  ...
  `lien_justificatif` varchar(500) DEFAULT NULL,
...
CREATE TABLE `experiences` (
  ...
  `type` enum('stage','emploi','benevolat','autre') DEFAULT 'stage',
...
(15, 14, 2, 'RE: RE: 📊 Résultats de votre questionnaire - Niveau Excellent', 'bonjour le conseiller', 1, '2026-05-11 07:21:58'),
(16, 14, 2, 'RE: RE: 📊 Résultats de votre questionnaire - Niveau Excellent', 'Merci', 1, '2026-05-11 07:22:21'),
(18, 14, 18, 'RE: orientation', 'd&#039;accor merci. Qu&#039;est ce que je dois faire alors', 1, '2026-05-11 07:49:49'),
(19, 18, 14, 'orientation', 'salut, c\'est comment', 1, '2026-05-11 08:00:26'),
(20, 14, 18, 'RE: orientation', 'yafoy. je vais voir si c\'est possible de faire un effort', 1, '2026-05-11 08:02:01'),
(21, 18, 14, 'Mise à jour de votre candidature - developpeur web', 'Bonjour Mbaï-ndigssem,\n\nVotre candidature pour l\'offre \"developpeur web\" chez camtel a été mise à jour.\n\n📌 Nouveau statut : ✅ ACCEPTÉE\n\nFélicitations ! Nous vous contacterons très prochainement pour la suite du processus.\n\n💬 Commentaire du conseiller :\nBienvenu dans l\'entreprise \n\nCordialement,\nL\'équipe d\'orientation', 1, '2026-05-11 08:20:49'),
(23, 2, 14, '📊 Résultats de votre questionnaire - Niveau Excellent', 'Félicitations Mbaï-ndigssem ! 🎉\r\n\r\nVous avez obtenu un excellent score de 87% au questionnaire d\'orientation. Votre profil correspond parfaitement aux métiers recommandés.\r\n\r\n📊 Résultats :\r\n- Score : 87%\r\n- Niveau : Excellent\r\n- Bonnes réponses : 13/15\r\n- Filière : Informatique\r\n\r\nJe vous invite à consulter les ressources suggérées pour approfondir vos connaissances.\r\n\r\nN\'hésitez pas à me contacter pour un entretien personnalisé.\r\n\r\nBravo pour ce travail ! 👏', 0, '2026-05-14 12:45:35'),
(24, 2, 14, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'Bonjour Mbaï-ndigssem,\r\n\r\nJ\'ai pris connaissance des résultats de votre questionnaire. Votre score de {score}% montre que vous avez besoin de consolider certaines compétences.\r\n\r\n📊 Résultats :\r\n- Score : {score}%\r\n- Niveau : {niveau}\r\n- Bonnes réponses : {bonnes}/{total}\r\n- Filière : {filiere}\r\n\r\nNe vous découragez pas ! Je vous conseille vivement de consulter les ressources recommandées.\r\n\r\nJe reste disponible pour vous aider. 📚', 0, '2026-05-14 12:33:47'),
(25, 2, 14, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'Bonjour Mbaï-ndigssem,\r\n\r\nJ\'ai pris connaissance des résultats de votre questionnaire. Votre score de {score}% indique que vous auriez besoin d\'un accompagnement plus personnalisé.\r\n\r\n📊 Résultats :\r\n- Score : {score}%\r\n- Niveau : {niveau}\r\n- Bonnes réponses : {bonnes}/{total}\r\n- Filière : {filiere}\r\n\r\nJe vous propose de prendre rendez-vous avec moi pour discuter de votre parcours et des axes d\'amélioration.\r\n\r\nEnsemble, nous allons construire votre plan de progression. 🤝', 0, '2026-05-14 12:45:10'),
(26, 2, 19, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'sjssqgbqgq', 1, '2026-05-14 12:51:16'),
(27, 2, 14, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'Bonjour Mbaï-ndigssem,\r\n\r\nBon travail ! Vous avez obtenu un score de {score}% au questionnaire. Vous avez de bonnes bases dans votre domaine.\r\n\r\n📊 Résultats :\r\n- Score : {score}%\r\n- Niveau : {niveau}\r\n- Bonnes réponses : {bonnes}/{total}\r\n- Filière : {filiere}\r\n\r\nJe vous recommande de consulter les ressources pédagogiques pour renforcer vos compétences.\r\n\r\nRestez motivé ! 💪', 0, '2026-05-14 12:53:01'),
(28, 2, 14, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'Bonjour Mbaï-ndigssem,\r\n\r\nBon travail ! Vous avez obtenu un score de {score}% au questionnaire. Vous avez de bonnes bases dans votre domaine.\r\n\r\n📊 Résultats :\r\n- Score : {score}%\r\n- Niveau : {niveau}\r\n- Bonnes réponses : {bonnes}/{total}\r\n- Filière : {filiere}\r\n\r\nJe vous recommande de consulter les ressources pédagogiques pour renforcer vos compétences.\r\n\r\nRestez motivé ! 💪', 0, '2026-05-14 12:55:00'),
(29, 2, 14, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'Félicitations Mbaï-ndigssem ! 🎉\r\n\r\nVous avez obtenu un excellent score de {score}% au questionnaire d\'orientation. Votre profil correspond parfaitement aux métiers recommandés.\r\n\r\n📊 Résultats :\r\n- Score : {score}%\r\n- Niveau : {niveau}\r\n- Bonnes réponses : {bonnes}/{total}\r\n- Filière : {filiere}\r\n\r\nJe vous invite à consulter les ressources suggérées pour approfondir vos connaissances.\r\n\r\nN\'hésitez pas à me contacter pour un entretien personnalisé.\r\n\r\nBravo pour ce travail ! 👏', 0, '2026-05-14 12:57:04'),
(30, 2, 14, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'Bonjour Mbaï-ndigssem,\r\n\r\nJ\'ai pris connaissance des résultats de votre questionnaire. Votre score de {score}% indique que vous auriez besoin d\'un accompagnement plus personnalisé.\r\n\r\n📊 Résultats :\r\n- Score : {score}%\r\n- Niveau : {niveau}\r\n- Bonnes réponses : {bonnes}/{total}\r\n- Filière : {filiere}\r\n\r\nJe vous propose de prendre rendez-vous avec moi pour discuter de votre parcours et des axes d\'amélioration.\r\n\r\nEnsemble, nous allons construire votre plan de progression. 🤝', 0, '2026-05-14 13:27:59'),
(31, 18, 14, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'Bonjour Mbaï-ndigssem,\r\n\r\nJ\'ai pris connaissance des résultats de votre questionnaire. Votre score de {score}% indique que vous auriez besoin d\'un accompagnement plus personnalisé.\r\n\r\n📊 Résultats :\r\n- Score : {score}%\r\n- Niveau : {niveau}\r\n- Bonnes réponses : {bonnes}/{total}\r\n- Filière : {filiere}\r\n\r\nJe vous propose de prendre rendez-vous avec moi pour discuter de votre parcours et des axes d\'amélioration.\r\n\r\nEnsemble, nous allons construire votre plan de progression. 🤝', 0, '2026-05-14 13:48:39'),
(32, 2, 21, '📊 Résultats de votre questionnaire - Niveau Moyen', 'Bonjour hdegdgdh,\r\n\r\nJ\'ai pris connaissance des résultats de votre questionnaire. Votre score de 40% montre que vous avez besoin de consolider certaines compétences.\r\n\r\n📊 Résultats :\r\n- Score : 40%\r\n- Niveau : Moyen\r\n- Bonnes réponses : 4/10\r\n- Filière : Médecine\r\n\r\nNe vous découragez pas ! Je vous conseille vivement de consulter les ressources recommandées.\r\n\r\nJe reste disponible pour vous aider. 📚', 1, '2026-05-15 07:48:51'),
(33, 21, 2, 'RE: 📊 Résultats de votre questionnaire - Niveau Moyen', 'mr-crd', 1, '2026-05-15 07:49:48'),
(34, 2, 21, 'RE: RE: 📊 Résultats de votre questionnaire - Niveau Moyen', 'GYTBTBOTBIB', 0, '2026-05-17 06:16:33'),
(35, 2, 23, 'Re: 📊 Résultats de votre questionnaire - Niveau Moyen', 'tf(v-t-bt', 0, '2026-05-17 07:04:06');
...
--
-- Structure de la table `notes_etudiant`
--
...
CREATE TABLE `notes_etudiant` (
  ...
  `annee_academique` year(4) DEFAULT NULL,
  `date_ajout` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Déchargement des données de la table `notes_etudiant`
--

INSERT INTO `notes_etudiant` (`id`, `etudiant_id`, `niveau`, `nom_ue`, `coefficient`, `note`, `annee_academique`, `date_ajout`) VALUES
(1, 20, 'L3', 'BD', 6.00, 18.00, '2026', '2026-05-14 17:37:30'),
(2, 20, 'L1', 'RO', 6.00, 15.00, '2026', '2026-05-14 17:38:13'),
(3, 20, 'L1', 'ASR', 6.00, 18.00, '2026', '2026-05-14 17:39:22'),
(4, 21, 'L1', 'BD', 4.00, 17.00, '2023', '2026-05-14 18:40:47'),
(5, 21, 'L1', 'BD', 4.00, 17.00, '2023', '2026-05-14 18:42:08'),
(6, 21, 'L2', 'BDN', 4.00, 17.00, '2023', '2026-05-14 18:42:44'),
(7, 21, 'L1', 'BBSBB', 9.00, 9.00, '2022', '2026-05-15 06:48:45'),
(8, 22, 'L1', 'BD', 6.00, 16.00, '2023', '2026-05-15 15:57:38'),
(9, 22, 'L1', 'EO', 2.00, 9.00, NULL, '2026-05-15 15:58:30'),
(10, 22, 'L2', 'PR', 5.00, 12.00, '2025', '2026-05-15 15:59:24'),
(11, 22, 'L2', 'GDD', 6.00, 15.00, '2025', '2026-05-15 15:59:51');

-- --------------------------------------------------------

--
-- Structure de la table `objectifs_carriere`
--

CREATE TABLE `objectifs_carriere` (
  `id` int(11) NOT NULL,
  `etudiant_id` int(11) NOT NULL,
  `metier_cible` varchar(150) NOT NULL,
  `description_objectif` text DEFAULT NULL,
...
CREATE TABLE `offres` (
  `id` int(11) NOT NULL,
  `titre` varchar(200) NOT NULL,
  `type` enum('emploi','stage') DEFAULT 'stage',
  ...
  `statut` enum('active','expiree','fermee') DEFAULT 'active',
  `publiee_par` int(11) DEFAULT NULL,
...
INSERT INTO `offres` (`id`, `titre`, `type`, `entreprise`, `lieu`, `description`, `competences_requises`, `duree`, `date_limite`, `statut`, `publiee_par`, `date_publication`) VALUES
(1, 'developpeur web', 'emploi', 'camtel', 'ngaoundere', 'developper des logiciels mobiles', 'python et php', '3 mois', '2026-05-21', 'active', 18, '2026-05-11 08:14:41');
...
INSERT INTO `profils_etudiants` (`id`, `etudiant_id`, `matricule`, `date_naissance`, `telephone`, `adresse`, `annee_bac`, `filiere_id`, `niveau`, `moyenne_generale`, `interets`, `biographie`, `date_maj`) VALUES
(4, 1, NULL, NULL, NULL, NULL, NULL, 1, 'L3', 19.00, 'IA', NULL, '2026-04-15 22:39:14'),
(13, 14, NULL, NULL, NULL, NULL, NULL, 1, 'L3', 12.50, 'reseau informatique', NULL, '2026-05-11 06:38:52'),
(14, 19, NULL, NULL, NULL, NULL, NULL, 1, 'L1', 11.00, '', NULL, '2026-05-14 12:43:12'),
(15, 20, '65826', '2026-05-30', 'EYTYTYTHY', 'HRYRHF', '2023', 1, 'L3', 14.98, 'BD', NULL, '2026-05-14 17:59:18'),
(16, 21, 'VDD', '2026-05-29', 'SDD24', 'TGYGG', '2023', 10, 'L1', 13.57, 'TGGGVTGV', NULL, '2026-05-15 06:48:45'),
(17, 22, '6582', '2026-05-29', 'F68YGG967Y', 'GYY', NULL, 1, 'L3', 13.89, 'PROGRAMMATION', NULL, '2026-05-15 15:59:51'),
(18, 23, NULL, NULL, NULL, NULL, NULL, NULL, 'L1', 0.00, NULL, NULL, '2026-05-17 06:11:07');
...
(229, 14, 1, 'a', '2026-05-11 06:52:09'),
(230, 14, 2, 'a', '2026-05-11 06:52:09'),
(231, 14, 3, 'a', '2026-05-11 06:52:09'),
(232, 14, 4, 'a', '2026-05-11 06:52:09'),
(233, 14, 5, 'a', '2026-05-11 06:52:09'),
(234, 14, 6, 'a', '2026-05-11 06:52:10'),
(235, 14, 7, 'a', '2026-05-11 06:52:10'),
(236, 14, 8, 'a', '2026-05-11 06:52:10'),
(237, 14, 9, 'c', '2026-05-11 06:52:10'),
(238, 14, 10, 'a', '2026-05-11 06:52:10'),
(239, 14, 11, 'a', '2026-05-11 06:52:11'),
(240, 14, 12, 'a', '2026-05-11 06:52:11'),
(241, 14, 13, 'a', '2026-05-11 06:52:11'),
(242, 14, 14, 'a', '2026-05-11 06:52:11'),
(243, 14, 15, 'c', '2026-05-11 06:52:11'),
(259, 19, 1, 'a', '2026-05-14 12:43:25'),
(262, 19, 2, 'a', '2026-05-14 12:47:16'),
(263, 19, 3, 'b', '2026-05-14 12:47:16'),
(264, 19, 4, 'b', '2026-05-14 12:47:16'),
(269, 19, 5, 'd', '2026-05-14 12:47:40'),
(275, 19, 6, 'b', '2026-05-14 12:48:11'),
(276, 19, 8, 'a', '2026-05-14 12:48:11'),
(277, 19, 10, 'c', '2026-05-14 12:48:11'),
(278, 19, 11, 'a', '2026-05-14 12:48:11'),
(279, 19, 12, 'd', '2026-05-14 12:48:11'),
(280, 19, 13, 'a', '2026-05-14 12:48:11'),
(281, 19, 14, 'b', '2026-05-14 12:48:11'),
(282, 19, 15, 'a', '2026-05-14 12:48:11'),
(289, 19, 7, 'b', '2026-05-14 12:48:46'),
(291, 19, 9, 'b', '2026-05-14 12:48:46'),
(388, 21, 36, 'a', '2026-05-15 07:48:40'),
(389, 21, 37, 'a', '2026-05-15 07:48:40'),
(390, 21, 38, 'c', '2026-05-15 07:48:40'),
(391, 21, 39, 'a', '2026-05-15 07:48:40'),
(392, 21, 41, 'a', '2026-05-15 07:48:40'),
(393, 21, 44, 'b', '2026-05-15 07:48:40'),
(394, 21, 45, 'c', '2026-05-15 07:48:40'),
(395, 22, 1, 'b', '2026-05-15 16:02:35'),
(396, 22, 3, 'c', '2026-05-15 16:02:35'),
(398, 22, 2, 'd', '2026-05-15 16:03:43'),
(400, 22, 5, 'c', '2026-05-15 16:03:43'),
(401, 22, 7, 'b', '2026-05-15 16:03:43'),
(402, 22, 9, 'a', '2026-05-15 16:03:43'),
(403, 22, 11, 'b', '2026-05-15 16:03:43'),
(404, 22, 13, 'd', '2026-05-15 16:03:43'),
(405, 22, 15, 'b', '2026-05-15 16:03:43');
...
(1, 'admin', 'Système', 'admin@orientation.cm', '123456d', 'admin', '2026-04-15 22:35:49', 1),
...
(14, 'Dieudonné', 'Mbaï-ndigssem', 'mbaindigssemdieudonne@gmail.com', '$2y$10$IH93b/bqNFi8QThh/wIlo.IElnPb4J9D0r8fYL1peO/8u4jTrjxh6', 'etudiant', '2026-05-11 06:38:03', 1),
(15, 'Dieudonné', 'Mbaï-ndigssem', 'dieudonne@gmail.com', '$2y$10$mhvTUrLb81EGnYUKaEC8Ru78leXy9DATyOT.Gsf01mutfZwbs.LRi', 'admin', '2026-05-11 07:00:12', 1),
(16, 'Dieudonné', 'Mbaï-ndigssem', 'mbai@gmail.com', '$2y$10$5uFkG2j641agzFV5yrsR3Ok/0gmo/6C2prZWOe/jbsHuW5BwqtmSm', 'etudiant', '2026-05-11 07:05:00', 1),
(17, 'Dieudonné', 'Mbaï-ndigssem', 'dieu@gmail.com', '$2y$10$zPixC44P4kzOJwfFYbn0geknj55.ScnTitRPn/6dle71cH4esJ.L.', 'admin', '2026-05-11 07:06:33', 1),
(18, 'Remadji', 'salomene', 'salomene@gmail.com', '$2y$10$2kE/Gv3GOTOf7lvnpJtMceAWJxkGSfUsXth3uPZulhaxUx9SnFjiK', 'conseiller', '2026-05-11 07:08:59', 1),
(19, 'lalala', 'kkzkz', 'ww@gmail.com', '$2y$10$CVKUnNkXEl7rVyTQFH3AHO6raoX5vGt8xii4u2YWl8RkY.KtIqR3O', 'etudiant', '2026-05-14 12:30:50', 1),
(20, 'lalala', 'kk', 'vvv@gmail.com', '$2y$10$.S48VVtmeI.IERToLw7lo.M6ABnbJED7nczB8foa4La9JEWyhzMgq', 'etudiant', '2026-05-14 17:34:54', 1),
(21, 'hdhdhd', 'hdegdgdh', 'vvvcc@gmail.com', '$2y$10$4c2Mi.aQuih0EiXhPjAtCOWhfUGERLQmwusUN7TmhRevG503kPQyy', 'etudiant', '2026-05-14 18:15:26', 1),
(22, 'fhffhf', 'yr_ru_çirçri', 'vvvccrr@gmail.com', '$2y$10$5T6wB7atbFXBwkWI2ntaa.n61UZYgtnQiecZKXOsnM04cHTSee4Jy', 'etudiant', '2026-05-15 15:53:25', 1),
(23, 'figtbuhkijoi', 'yuhontghinoyu', 'bbvvvccrr@gmail.com', '$2y$10$X48Q.IyObQ1q/NlfVPN2LerbAxd0JEGCYrLmTPI0P/88IjhI7dGSS', 'etudiant', '2026-05-17 06:11:07', 1);
...
--
-- Index pour la table `notes_etudiant`
--
ALTER TABLE `notes_etudiant`
  ADD PRIMARY KEY (`id`),
  ADD KEY `etudiant_id` (`etudiant_id`);

--
-- Index pour la table `objectifs_carriere`
--
ALTER TABLE `objectifs_carriere`
  ADD PRIMARY KEY (`id`),
  ADD KEY `etudiant_id` (`etudiant_id`);
...
ALTER TABLE `offres`
  ADD PRIMARY KEY (`id`),
  ADD KEY `publiee_par` (`publiee_par`);
...
--
-- AUTO_INCREMENT pour la table `notes_etudiant`
--
ALTER TABLE `notes_etudiant`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT pour la table `objectifs_carriere`
--
ALTER TABLE `objectifs_carriere`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
